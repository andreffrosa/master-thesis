...
EXPERIMENTS[0]=$DIR_PATH$FRAMEWORK' '$ARGS' '$FLOODING' '$NEIGH_TIMER
RESULTS[0]=$YGGHOME"bcast_results/""FLOODING+NEIGH_TIMER_3"

EXPERIMENTS[1]=$DIR_PATH$FRAMEWORK' '$ARGS' '$NABA_0_0' '$NEIGH_TIMER
RESULTS[1]=$YGGHOME"bcast_results/""NABA-v0-0+NEIGH_TIMER_2"

EXPERIMENTS[2]=$DIR_PATH$FRAMEWORK' '$ARGS' '$NABA_0_1' '$NULL_TIMER
RESULTS[2]=$YGGHOME"bcast_results/""NABA-v0-1+NULL_TIMER_2"

EXPERIMENTS[3]=$DIR_PATH$FRAMEWORK' '$ARGS' '$NABA_0_2' '$NULL_TIMER
RESULTS[3]=$YGGHOME"bcast_results/""NABA-v0-2+NULL_TIMER_2"

EXPERIMENTS[4]=$DIR_PATH$FRAMEWORK' '$ARGS' '$NABA_0_2' '$NEIGH_TIMER
RESULTS[4]=$YGGHOME"bcast_results/""NABA-v0-2+NEIGH_TIMER_3"

EXPERIMENTS[5]=$DIR_PATH$FRAMEWORK' '$ARGS' '$NABA_3' '$NULL_TIMER
RESULTS[5]=$YGGHOME"bcast_results/""NABA-v3+NULL_TIMER_1"
