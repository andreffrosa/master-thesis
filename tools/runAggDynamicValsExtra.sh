...
sleep $WAIT_TIME
  ...
  stop_experience "${SRDS18}nofaults_dynamic_${changes}_aggGapBcastTest_root_${gap_root}_$i"
  ...
  sleep $WAIT_TIME
    ...
    stop_experience "${SRDS18}nofaults_dynamic_${changes}_aggFlowTest_$i"
  ...
  sleep $WAIT_TIME
    ...
    sleep $WAIT_TIME
      ...
      stop_experience "${SRDS18}nofaults_dynamic_${changes}_aggLimoTest_$i"
  ...
  stop_experience "${SRDS18}nofaults_dynamic_${changes}_aggGapTest_root_${gap_root}_$i"
