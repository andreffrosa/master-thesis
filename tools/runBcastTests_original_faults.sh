...
SLEEP="20000" #ms interval between broadcast
...
ARGS="-i "$[$DISCOVERY_PERIOD*1000]" -s "$SLEEP" -p 1.0 -b -d "$DURATION" "$OVERLAY
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$FLOODING' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Flooding+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$FLOODING' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Flooding+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$FLOODING' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Flooding+Fixed_Timer"
((EXP_COUNTER++))
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$GOSSIP' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Gossip+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$GOSSIP' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Gossip+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$GOSSIP' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Gossip+Fixed_Timer"
((EXP_COUNTER++))
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$COUNTING' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Counting+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$COUNTING' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Counting+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$COUNTING' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Counting+Fixed_Timer"
((EXP_COUNTER++))
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_0' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_0+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_0' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_0+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_0' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_0+Fixed_Timer"
((EXP_COUNTER++))
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_1' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_1+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_1' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_1+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_1' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_1+Fixed_Timer"
((EXP_COUNTER++))
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_1' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_2+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_1' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_2+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_0_1' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v0_2+Fixed_Timer"
((EXP_COUNTER++))
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_1' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v1+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_1' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v1+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_1' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v1+Fixed_Timer"
((EXP_COUNTER++))
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_2" -a $PHASES"' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v2_$PHASES+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_2" -a $PHASES"' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v2_$PHASES+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_2" -a $PHASES"' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v2_$PHASES+Fixed_Timer"
((EXP_COUNTER++))
...
EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_3" -a $PHASES"' '$RANDOM_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v3_$PHASES+Random_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_3" -a $PHASES"' '$NEIGH_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v3_$PHASES+Neighbours_Timer"
((EXP_COUNTER++))

EXPERIMENTS[$EXP_COUNTER]=$FRAMEWORK' '$NABA_3" -a $PHASES"' '$FIXED_TIMER
EXP_NAME[$EXP_COUNTER]="Naba-v3_$PHASES+Fixed_Timer"
((EXP_COUNTER++))
...
TOTAL_TIME=$["((3*$RUNS*$n_exp*($EXP_TIME + 2*$WAIT_TIME)) + 3*$WAIT_TIME)"]
...
tokill=(9 21 11 15 19 6)
for changes in 3 6; do
...
for (( i=0; i < $n_exp; i++ )); do
  ...
  stop_experience "$RESULTS_DIR${EXP_NAME[i]}_faults${changes}_run$r.txt $pis"
  echo "Killed Pis: $pis"

  ENDTIME=$(date +%s)
  elapsed=$(($ENDTIME - $STARTTIME))

echo "sleep $((($EXP_TIME) - $elapsed)) s"
  sleep $((($EXP_TIME) - $elapsed))

  stop_experience "$RESULTS_DIR${EXP_NAME[i]}_faults${changes}_run$r.txt"
  echo "$RESULTS_DIR${EXP_NAME[i]}_faults${changes}_run$r.txt"
