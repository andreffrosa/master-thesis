...
for i in $(seq 1 $n_runs); do
  ...
  STARTTIME=$(date +%s)
    ...
    stop_experience "${SRDS18}faults_${changes}_aggMultiTesV2t_${lowest_tree}_$i $pis"
    echo "Killed Pis: $pis"
  ...
  stop_experience "${SRDS18}faults_${changes}_aggMultiTestV2_${lowest_tree}_$i"
...
for i in $(seq 1 $n_runs); do
  ...
  stop_experience "${SRDS18}link_faults_${changes}_aggMultiTestV2_${lowest_tree}_$i"
...
for i in $(seq 1 $n_runs); do
  ...
  stop_experience "${SRDS18}nofaults_dynamic_${changes}_aggMultiTestV2_${lowest_tree}_$i"
