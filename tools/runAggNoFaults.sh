...
for i in 4 5 6; do
  ...
  stop_experience "${SRDS18}nofaults_aggMultiTest_${lowest_tree}_$i"
  ...
  stop_experience "${SRDS18}nofaults_aggFlowTest_$i"
  ...
  stop_experience "${SRDS18}nofaults_aggLimoTest_$i"
  ...
  stop_experience "${SRDS18}nofaults_aggGapTest_root_${gap_root}_$i"
  ...
  stop_experience "${SRDS18}nofaults_aggGapBcastTest_root_${gap_root}_$i"
