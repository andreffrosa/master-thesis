...
echo "----------------- BEGIN NOFAULTS ---------------------"
  ...
  stop_experience "${SRDS18}nofaults_aggMultiTest_${lowest_tree}_${active_neigh}_$i"
...
changes=1
  ...
  stop_experience "${SRDS18}faults_${changes}_aggMultiTest_${lowest_tree}_${active_neigh}_$i $pis"
  echo "Killed Pis: $pis"
  ...
  stop_experience "${SRDS18}faults_${changes}_aggMultiTest_${lowest_tree}_${active_neigh}_$i"
