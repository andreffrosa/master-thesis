...
tokill=(5 9 1 11 23 16 16 19 14 15 5 7 23 22 20 18 16 21 6 8 21 18 8 9)
for changes in 3 9; do
...
echo "sleep $((($EXP_TIME) - $elapsed)) s"
  ...
  stop_experience "$RESULTS_DIR${EXP_NAME[i]}_link${changes}_run$r.txt"
  echo "$RESULTS_DIR${EXP_NAME[i]}_link${changes}_run$r.txt"
