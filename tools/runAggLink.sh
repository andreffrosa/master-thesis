...
for i in 4 5 6; do
  ...
  stop_experience "${SRDS18}link_faults_${changes}_aggMultiTest_${lowest_tree}_$i"
  ...
  stop_experience "${SRDS18}link_faults_${changes}_aggFlowTest_$i"
  ...
  stop_experience "${SRDS18}link_faults_${changes}_aggLimoTest_$i"
  ...
  stop_experience "${SRDS18}link_faults_${changes}_aggGapTest_root_${gap_root}_$i"
  ...
  stop_experience "${SRDS18}link_faults_${changes}_aggGapBcastTest_root_${gap_root}_$i"
