...
int ygg_runtime_init_2(NetworkConfig* ntconf, const char* hostname) {

	ygg_loginit_2(hostname); //Initialize logger
...
void setmyId(uuid_t id) {
	memcpy(myuuid, id, sizeof(uuid_t));
}
