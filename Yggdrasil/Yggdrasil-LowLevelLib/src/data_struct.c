...
NetworkConfig* defineNetworkConfig(char* type, int freq, int nscan, short mandatory, char* name, const struct sock_filter* filter){
    ...
    ntconf->interface_name = "wlan0";

	return ntconf;
}

NetworkConfig* defineNetworkConfig2(char* interface_name, char* type, int freq, int nscan, short mandatory, char* name, const struct sock_filter* filter){
	NetworkConfig* ntconf = (NetworkConfig*) malloc(sizeof(struct _NetworkConfig));
    ...
    ntconf->interface_name = interface_name;
