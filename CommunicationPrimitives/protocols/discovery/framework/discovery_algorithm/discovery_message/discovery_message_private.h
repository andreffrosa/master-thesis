...
typedef void (*d_msg_create_message)(ModuleState*, unsigned char*, struct timespec*, NeighborsTable*, DiscoveryInternalEventType, void*, HelloMessage*, HackMessage*, byte, byte*, unsigned short*);
