...
HelloScheduler* newHelloScheduler(HelloSchedulerType hello_type, PiggybackType piggyback_type, PeriodicType periodic_type, bool react_to_new_neighbor, bool react_to_lost_neighbor, bool react_to_update_neighbor, bool react_to_new_2hop_neighbor, bool react_to_lost_2hop_neighbor, bool react_to_update_2hop_neighbor) {

    HelloScheduler* hello_sh = malloc(sizeof(HelloScheduler));

    HELLO_update(hello_sh, hello_type, piggyback_type, periodic_type, react_to_new_neighbor, react_to_lost_neighbor, react_to_update_neighbor, react_to_new_2hop_neighbor, react_to_lost_2hop_neighbor, react_to_update_2hop_neighbor);
...
HelloScheduler* NoHELLO() {
    return newHelloScheduler(NO_HELLO, NO_PIGGYBACK, NO_PERIODIC, false, false, false, false, false, false);
}

HelloScheduler* PiggybackHELLO(PiggybackType piggyback_type) {
    return newHelloScheduler(PIGGYBACK_HELLO, piggyback_type, NO_PERIODIC, false, false, false, false, false, false);
}
...
HelloScheduler* PeriodicHELLO(bool react_to_new_neighbor, bool react_to_lost_neighbor, bool react_to_update_neighbor, bool react_to_new_2hop_neighbor, bool react_to_lost_2hop_neighbor, bool react_to_update_2hop_neighbor) {
    ...
    return newHelloScheduler(PERIODIC_HELLO, NO_PIGGYBACK, STATIC_PERIODIC, react_to_new_neighbor, react_to_lost_neighbor, react_to_update_neighbor, react_to_new_2hop_neighbor, react_to_lost_2hop_neighbor, react_to_update_2hop_neighbor);
}
...
HelloScheduler* HybridHELLO(PiggybackType piggyback_type, bool react_to_new_neighbor, bool react_to_lost_neighbor, bool react_to_update_neighbor, bool react_to_new_2hop_neighbor, bool react_to_lost_2hop_neighbor, bool react_to_update_2hop_neighbor) {
    ...
    return newHelloScheduler(HYBRID_HELLO, piggyback_type, RESET_PERIODIC, react_to_new_neighbor, react_to_lost_neighbor, react_to_update_neighbor, react_to_new_2hop_neighbor, react_to_lost_2hop_neighbor, react_to_update_2hop_neighbor);
}

static bool HelloRepresentationInvariant(HelloScheduler* hello_sh, HelloSchedulerType hello_type, PiggybackType piggyback_type, PeriodicType periodic_type, bool react_to_new_neighbor, bool react_to_lost_neighbor, bool react_to_update_neighbor, bool react_to_new_2hop_neighbor, bool react_to_lost_2hop_neighbor, bool react_to_update_2hop_neighbor) {
    if(hello_sh == NULL)
        return false;
    ...
    switch( hello_type ) {
        ...
        case PIGGYBACK_HELLO:
            return piggyback_type != NO_PIGGYBACK && periodic_type == NO_PERIODIC && !react;
        case PERIODIC_HELLO:
            return piggyback_type == NO_PIGGYBACK && periodic_type == STATIC_PERIODIC;
        case HYBRID_HELLO:
...
void HELLO_update(HelloScheduler* hello_sh, HelloSchedulerType hello_type, PiggybackType piggyback_type, PeriodicType periodic_type, bool react_to_new_neighbor, bool react_to_lost_neighbor, bool react_to_update_neighbor, bool react_to_new_2hop_neighbor, bool react_to_lost_2hop_neighbor, bool react_to_update_2hop_neighbor) {
    assert( HelloRepresentationInvariant(hello_sh, hello_type, piggyback_type, periodic_type, react_to_new_neighbor, react_to_lost_neighbor, react_to_update_neighbor, react_to_new_2hop_neighbor, react_to_lost_2hop_neighbor, react_to_update_2hop_neighbor) );
